...
settings = {
    ...
    "Pt1Cu1Fe1Mo1" : {
        ...
        "vari_range" : 0.1},
    "NaCl_1" : {
        "State" : 0, "Symbol" : "Na_4+Cl_4", "grid" : 4, "cell_size" : 5.64, "view" : True,
        "calc" : "LJ_ElliottAkerson_2015_Universal__MO_959249795837_003",
        "vari_range" : 0.3},
    "SrTiO3_1" : {
        "State" : 0, "Symbol" : "Sr_1+Ti_1+O_3", "grid" : 2, "cell_size" : 3.9, "view" : True,
    ...
    "TiZrHfScMo" : {
        ...
        "vari_range" : 0.2},
    "LiCo_cathode" : {
        "State" : 5, "Symbol" : "Li_2+Co_3+O_6", "grid" : [15, 503, 96], "cell_size" : [2.81126, 2.81126, 13.90946], "view" : True,
