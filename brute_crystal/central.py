...
settings = {
    ...
    "Pt3Cu1_1": {
        "State": 0, "Symbol": "Pt_3+Cu_1", "grid": 4, "cell_size": 3.92, "view" : True,
        "calc": "EAM_Dynamo_ZhouJohnsonWadley_2004_CuAgAuNiPdPtAlPbFeMoTaWMgCoTiZr__MO_870117231765_000",
        "vari_range": 0.2
    },
    "C_1": {
    ...
    "SrTiO3_1" : {
        ...
        "vari_range" : 0.3},
    "NCM_battery" : {
        "State" : 5, "Symbol" : "Li_192+O_384+Ni_160+Co_16+Mn_16", "grid" : [157, 35, 54], "cell_size" : [10.05628 * 2, 5.79685 * 2, 14.28257 * 2], "view" : True,
        "calc" : "LJ_ElliottAkerson_2015_Universal__MO_959249795837_003",
        "vari_range" : 0.2}
}
